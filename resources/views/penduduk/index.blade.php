                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nomor_kps" required placeholder="Jika Ada">
                      </div>
                      <div class="form-group">
                        <label>Kebangsaan</label>
                        <input type="text" class="form-control" name="kebangsaan" required placeholder="Kebangsaan">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        <label>Kebangsaan</label>
                        <input type="text" class="form-control" name="kebangsaan" id="kebangsaan" required placeholder="Kebangsaan">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        <label>Warga Negara</label>
                        <select name="warga_negara" class="form-control" id="warga_negara" required>
                          <option selected disabled>Pilih</option>
                          <option value="WNI">WNI</option>
                          <option value="WNA">WNA</option>
                        </select>
...
$('#edit').on('show.bs.modal', function(event){
    ...
    var nomor_kps = row.data('nomor_kps');
    var kebangsaan = row.data('kebangsaan');
