...
<body>
	...
	<div class="format">
		...
		<p style="text-align: center; margin-top: -10px;">Nomor: 400/{{ $data->nomor_surat }}/2005/Kesra/{{ date('Y') }}</p>
		...
		<table cellpadding="0" cellspacing="0">
			...
			<tr>
				<td style="width: 39%;"></td>
				<td style="width: 1%;" valign="top">-</td>
				<td style="width: 60%;">Bahwa yang bersangkutan memang benar dari keluarga miskin.</td>
			</tr>
		</table>
