...
<body>
	...
	<table>
		...
		<tr>
			<td style="width: 40%;">4. Kewarganegaraan</td>
			<td style="width: 2%;">:</td>
			<td style="width: 40%;">lorem</td>
		</tr>
		<tr>
		...
		<tr>
			<td style="width: 40%;">11. Alamat</td>
			<td style="width: 2%;">:</td>
			<td style="width: 40%;">lorem</td>
		</tr>
		<tr>
			<td style="width: 40%;">12. Keterangan</td>
			<td style="width: 2%;">:</td>
			<td style="width: 40%;">lorem</td>
		</tr>
	</table>
	<p>Demikian surat keterangan ini dibuat untuk dapat dipergunakan sebagaimana mestinya.</p><br><br>
